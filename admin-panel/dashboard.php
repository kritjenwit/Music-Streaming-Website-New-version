...
<body class="">
    ...
    <ul class="nav justify-content-center nav-pills p-3 bg-secondary">
        ...
        <li class="nav-item">
            <a class="nav-link text-light" href="delete-music.php">Delete music or album</a>
        </li>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <ul class="pagination">
                                    ...
                                    <?php require "../php/admin-panel/opt/page-no/user-table.php"; ?>
                                    <li class="page-item">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <ul class="pagination">
                                    ...
                                    <?php require "../php/admin-panel/opt/page-no/music-table.php"; ?>
                                    <li class="page-item">
                                        <a class="page-link" href="#">Next</a>
                                    </li>
                                </ul>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <ul class="pagination">
                                    ...
                                    <?php require "../php/admin-panel/opt/page-no/album-table.php"; ?>
                                    <li class="page-item">
                                        <a class="page-link" href="#">Next</a>
                                    </li>
                                </ul>
